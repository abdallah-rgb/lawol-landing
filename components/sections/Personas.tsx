      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid gap-8 md:grid-cols-2 max-w-6xl mx-auto">
          ...
          <Reveal width="100%" delay={0.2}>
            <div className="group relative h-full overflow-hidden rounded-3xl bg-white/5 transition-all hover:shadow-xl border border-white/10 hover:border-primary/50">
              ...
              <div className="p-8">
                <p className="mb-6 text-text-light text-lg md:text-xl leading-relaxed">
          ...
          <Reveal width="100%" delay={0.5}>
            <div className="group relative h-full overflow-hidden rounded-3xl bg-secondary text-white transition-all hover:shadow-xl border border-secondary hover:border-primary/50">
               <div className="relative h-64 w-full overflow-hidden">
                <Image
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent" />
                <div className="absolute bottom-6 left-6 text-white">
                  <div className="mb-2 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-primary backdrop-blur-md">
              ...
              <div className="relative z-10 p-8">
                ...
                <p className="mb-6 text-gray-300 text-lg md:text-xl relative z-10 leading-relaxed">
